...
def get_visited_locations(path_info: str, start_location: tuple[int, int] = (0, 0)) -> tuple[int, set[tuple[int, int]]]:
    ...
    return len(seen_location), seen_location
...
def get_visited_locations_with_robot(path_info: str) -> int:
    ...
    santa_locations = get_visited_locations(santa_path)[1]
    robot_locations = get_visited_locations(robot_path)[1]
...
def get_answers():
    ...
    part_1_answer = get_visited_locations(elf_path_info)[0]
